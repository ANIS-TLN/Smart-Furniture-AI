...
import { getUser, updateUserInfos, getUserProducts, getUserProductsnnvalide } from "../../api";
...
export default function Profil() {
  ...
  return (
    <div>
      ...
      <div className="profil-wrapper">
        <div className="profil-header">
          ...
          <div className="profil-info">
            ...
            <p>{produits.length} {produits.length === 1 ? "produit mis en vente" : "produits mis en vente"}</p>
            <div className="profil-actions">
              ...
              <button title="Comandes recu" onClick={() => navigate("/commandes")}>
                <FiShoppingBag />
              </button>
            </div>
          </div>
      ...
      <div className="titre-produits">
        <h3><FaBoxOpen /> Mes produits en attente de validation</h3>
      </div>
